...
export function Ventas() {
  ...
  const agregarVenta = () => {
    ...
    let meseroSeleccionado = meseros.find(mesero => mesero.getRut === idMesero);
    let idProducto = parseInt(document.getElementById("nombreProducto").value);
    let productoSeleccionado = productos.find(producto => producto.getId === idProducto);
    ...
    const nuevaVenta = new Venta(idVenta, meseroSeleccionado, productoSeleccionado, cantidad, fecha);
  ...
  const guardarCambiosVenta = (ventaEditada) => {
    const nuevasVentas = ventas.map(venta => venta.getId === ventaEditada.getId ? ventaEditada : venta);
    setVentas(nuevasVentas);
  ...
  return (
    <div>
      <form className="container-fluid m-auto mt-5 col-12 col-lg-12 col-xxl-10 needs-validation-ventas" noValidate>
        <div className="container-fluid m-auto d-flex flex-column justify-content-center text-center">
          <div className="mt-1 mb-3 col-12 col-sm-10 col-md-8 col-lg-6 col-xxl-5 m-auto d-flex flex-wrap shadow rounded border border-info p-3">
            ...
            <div className="col-12 col-sm-10 col-md-10 col-lg-8 col-xl-7 text-center m-auto">
              ...
              <select name="nombreProducto" id="nombreProducto" className="form-select form-select-sm text-center" required defaultValue="">
              ...
              <div className="invalid-feedback">por favor selecciona un producto</div>
            </div>
            <div className="col-12 col-sm-10 col-md-10 col-lg-8 col-xl-7 text-center m-auto">
              <button type="button" className="mt-3 btn btn-info btn-sm p-2 m-auto fw-bold" data-bs-toggle="modal" data-bs-target="#verProductos">
                Ver Productos
              </button>
            </div>
            <div className="mt-5 col-12 col-sm-10 col-md-10 col-lg-8 col-xl-7 text-center m-auto">
              <label htmlFor="cantidad" className="form-label fw-bold">Ingresar cantidad del producto</label>
              <input type="number" className="form-control" id="cantidad" placeholder="Ingresar cantidad" min="1" step="1" onChange={handleCantidadChange} required />
            ...
            <div className="mt-5 col-12 col-sm-10 col-md-10 col-lg-8 col-xl-7 text-center m-auto">
              ...
              <select name="nombreMesero" id="nombreMesero" className="form-select form-select-sm text-center" required defaultValue="">
            ...
            <div className="mt-5 col-12 col-sm-10 col-md-10 col-lg-8 col-xl-7 text-center m-auto">
              ...
              <input type="date" name="fecha" id="fecha" className="form-control text-center" required max={new Date().toISOString().split("T")[0]} />
            ...
            <div className="mt-5 col-12 col-sm-10 col-md-10 col-lg-8 col-xl-6 text-center m-auto">
              <button type="button" className="btn btn-info fw-bold" id="ingresarVentaButton" onClick={agregarVenta}>
      ...
      <div className="miTabla mb-5 col-12 m-auto container">
        <div className="mb-3 col-10 col-xxl-3">
          <label htmlFor="buscarVentas" className="form-label justify-content-start">Buscar venta por ID</label>
          <input type="text" id="buscarVentas" className="form-control" placeholder="Buscar venta por ID..." />
        </div>
        <table className="container table table-striped table-bordered border-info text-center" id="tablaVentas">
          <thead>
            <tr>
              <th>ID</th>
              <th>Mesero</th>
          ...
          <tbody>
            {ventas && ventas.map(venta => (
              <tr key={venta.getId}>
                ...
                <td>
                  <button className="btn btn-primary" onClick={() => iniciarEdicionVenta(venta)}>
