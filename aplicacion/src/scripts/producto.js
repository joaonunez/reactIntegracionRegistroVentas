class Producto {
  ...
  let productos = [
    new Producto(1, "Café Espresso", { id: 1, nombre: "Bebestible" }, 1500),
    new Producto(2, "Capuccino", { id: 1, nombre: "Bebestible" }, 2000),
    new Producto(3, "Sandwich Ave", { id: 2, nombre: "Comestible" }, 3000),
    new Producto(4, "Té Verde", { id: 1, nombre: "Bebestible" }, 1200),
    new Producto(5, "Ensalada de Frutas", { id: 2, nombre: "Comestible" }, 1800),
    new Producto(6, "Hamburguesa Clásica", { id: 2, nombre: "Comestible" }, 2500),
    new Producto(7, "Ensalada César", { id: 2, nombre: "Comestible" }, 1800),
    new Producto(8, "Galletas de Chocolate", { id: 2, nombre: "Comestible" }, 1500),
    new Producto(9, "Agua Mineral", { id: 1, nombre: "Bebestible" }, 1000),
    new Producto(10, "Pizza Margarita", { id: 2, nombre: "Comestible" }, 2200),
    new Producto(11, "Helado de Vainilla", { id: 2, nombre: "Comestible" }, 2000),
  ];
  
  function actualizarDropdownProductos(comboBox1, comboBoxEditar) {
  ...
  function abrirModalEditarProducto(index) {
    ...
    document.getElementById("editarCategoriaProducto").value = producto.getCategoria.id;
  ...
  function editarProducto(index) {
    ...
    let newCategoria = categorias.find(cat => cat.id == newCategoriaId);
    ...
    actualizarTablaProductos(document.getElementById("tablaProductos2").getElementsByTagName("tbody")[0]);
    actualizarDropdownProductos(
      document.getElementById("nombreProducto"),
      document.getElementById("editarProductoVenta")
    );
  }
  ...
  function agregarProducto() {
    ...
    let categoriaSeleccionada = categorias.find(cat => cat.id == categoriaId);
  ...
  export { Producto, productos, actualizarDropdownProductos, actualizarTablaProductos, abrirModalEditarProducto, editarProducto, eliminarProducto, validarYAgregarProducto, agregarProducto };
